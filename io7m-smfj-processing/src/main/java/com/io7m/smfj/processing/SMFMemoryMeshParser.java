      ...
      throws IllegalStateException
    {
      ...
      try {
        try {
          ...
          for (final VectorI3L t : this.mesh.triangles()) {
            this.events.onDataTriangle(t.getXL(), t.getYL(), t.getZL());
          }
        } finally {
  ...
  private static abstract class AbstractParser
  {
      ...
      throws IOException
    {
      for (final VectorI2L v : y.values()) {
        this.events.onDataAttributeValueIntegerSigned2(v.getXL(), v.getYL());
      }
      return Unit.unit();
    }
      ...
      throws IOException
    {
      for (final VectorI3L v : y.values()) {
        this.events.onDataAttributeValueIntegerSigned3(
          v.getXL(), v.getYL(), v.getZL());
      }
      return Unit.unit();
    }
    ...
    {
      for (final VectorI2L v : y.values()) {
        this.events.onDataAttributeValueIntegerUnsigned2(
          v.getXL(), v.getYL());
      }
      return Unit.unit();
    }
    ...
    {
      for (final VectorI3L v : y.values()) {
        this.events.onDataAttributeValueIntegerUnsigned3(
          v.getXL(), v.getYL(), v.getZL());
      }
      return Unit.unit();
    }
      ...
      throws IOException
    {
      for (final VectorI4D v : y.values()) {
        this.events.onDataAttributeValueFloat4(
          v.getXD(), v.getYD(), v.getZD(), v.getWD());
      }
      return Unit.unit();
    }
  }
