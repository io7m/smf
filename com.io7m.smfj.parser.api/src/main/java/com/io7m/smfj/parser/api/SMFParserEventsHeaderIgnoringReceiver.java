...
/**
 * A convenient implementation of the {@link SMFParserEventsHeaderType}
 * interface that delegates warnings and errors but ignores data.
 */

public final class SMFParserEventsHeaderIgnoringReceiver
  implements SMFParserEventsHeaderType
{
  ...
  public SMFParserEventsHeaderIgnoringReceiver(
