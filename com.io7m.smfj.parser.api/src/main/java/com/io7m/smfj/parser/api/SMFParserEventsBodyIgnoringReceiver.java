...
/**
 * A convenient implementation of the {@link SMFParserEventsBodyType}
 * interface that delegates warnings and errors but ignores data.
 */

public final class SMFParserEventsBodyIgnoringReceiver
  implements SMFParserEventsBodyType
{
  ...
  public SMFParserEventsBodyIgnoringReceiver(
  ...
  {
    return Optional.of(new SMFParserEventsDataAttributesNonInterleavedIgnoringReceiver(
      this.receiver));
  }
  ...
  {
    return Optional.of(new SMFParserEventsDataTrianglesIgnoringReceiver(this.receiver));
  }
