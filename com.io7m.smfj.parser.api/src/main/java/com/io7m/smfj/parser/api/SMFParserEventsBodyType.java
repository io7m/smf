...
public interface SMFParserEventsBodyType
  extends SMFParserEventsErrorType,
  SMFParserEventsDataMetaOptionalSupplierType
{
  /**
   * @return A listener that will receive non-interleaved mesh data
   */
  ...
  /**
   * @return A listener that will receive triangle data
   */
