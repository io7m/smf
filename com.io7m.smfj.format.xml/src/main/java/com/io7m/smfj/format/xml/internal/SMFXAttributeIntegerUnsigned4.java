  ...
  implements BTElementHandlerType<Object, SMFVoid>
{
  ...
  {
    try {
      this.eventsValues.onDataAttributeValueIntegerSigned4(
        Long.parseUnsignedLong(attributes.getValue("c0")),
        Long.parseUnsignedLong(attributes.getValue("c1")),
        Long.parseUnsignedLong(attributes.getValue("c2")),
        Long.parseUnsignedLong(attributes.getValue("c3"))
      );
