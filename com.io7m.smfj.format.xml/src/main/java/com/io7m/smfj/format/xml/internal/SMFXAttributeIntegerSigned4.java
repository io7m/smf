    ...
    throws SAXException
  {
    try {
      this.eventsValues.onDataAttributeValueIntegerSigned4(
        Long.parseLong(attributes.getValue("c0")),
        Long.parseLong(attributes.getValue("c1")),
        Long.parseLong(attributes.getValue("c2")),
        Long.parseLong(attributes.getValue("c3"))
      );
