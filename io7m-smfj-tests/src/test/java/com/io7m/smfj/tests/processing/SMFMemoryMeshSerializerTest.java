...
public final class SMFMemoryMeshSerializerTest
{
  ...
  {
    final Vector<VectorI4D> v0 = a0.values();
    final Vector<VectorI4D> v1 = a1.values();
  ...
  {
    final Vector<VectorI3D> v0 = a0.values();
    final Vector<VectorI3D> v1 = a1.values();
  ...
  {
    final Vector<VectorI2D> v0 = a0.values();
    final Vector<VectorI2D> v1 = a1.values();
  ...
  {
    final Vector<VectorI4L> v0 = a0.values();
    final Vector<VectorI4L> v1 = a1.values();
  ...
  {
    final Vector<VectorI3L> v0 = a0.values();
    final Vector<VectorI3L> v1 = a1.values();
  ...
  {
    final Vector<VectorI2L> v0 = a0.values();
    final Vector<VectorI2L> v1 = a1.values();
