...
public final class SMFFormatBinaryRandomAccessFloatingTest extends SMFBinaryTest
{
  private static final Logger LOG;

  static {
    LOG = LoggerFactory.getLogger(SMFFormatBinaryRandomAccessFloatingTest.class);
  }
  ...
  private static SMFHeader header(final SMFAttribute attr)
  {
    ...
    hb.setCoordinateSystem(SMFCoordinateSystem.of(
      CAxisSystem.of(CAxis.AXIS_POSITIVE_X,
