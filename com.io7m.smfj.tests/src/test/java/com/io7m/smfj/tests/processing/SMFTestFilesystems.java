...
public final class SMFTestFilesystems
{
  private SMFTestFilesystems()
  {
    throw new UnreachableCodeException();
  }

  public static FileSystem makeEmptyUnixFilesystem()
  {
    try {
      ...
      base.addFileAttributeView(PosixFileAttributeView.class);
      return base.build("catalog");
    } catch (final IOException e) {
      throw new UnreachableCodeException(e);
    }
  }

  public static FileSystem makeEmptyDOSFilesystem()
  {
    try {
