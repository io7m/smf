...
public final class SMFBv1SectionParserVerticesNonInterleavedIntegerUnsignedTest
{
    ...
    final @Mocked SMFParserEventsBodyType events_body)
  {
    ...
    {{
      ...
      events_values.onDataAttributeValueIntegerUnsigned4(
        10L, 20L, 30L, 40L);
      events_values.onDataAttributeValueIntegerUnsigned4(
        11L, 21L, 31L, 41L);
      events_values.onDataAttributeValueFinish();
    ...
    final @Mocked SMFParserEventsBodyType events_body)
  {
    ...
    {{
      ...
      events_values.onDataAttributeValueIntegerUnsigned3(
        10L, 20L, 30L);
      events_values.onDataAttributeValueIntegerUnsigned3(
        11L, 21L, 31L);
      events_values.onDataAttributeValueFinish();
    ...
    final @Mocked SMFParserEventsBodyType events_body)
  {
    ...
    {{
      ...
      events_values.onDataAttributeValueIntegerUnsigned2(
        10L, 20L);
      events_values.onDataAttributeValueIntegerUnsigned2(
        11L, 21L);
      events_values.onDataAttributeValueFinish();
    ...
    final @Mocked SMFParserEventsBodyType events_body)
  {
    ...
    {{
      ...
      events_values.onDataAttributeValueIntegerUnsigned1(
        10L);
      events_values.onDataAttributeValueIntegerUnsigned1(
        11L);
      events_values.onDataAttributeValueFinish();
