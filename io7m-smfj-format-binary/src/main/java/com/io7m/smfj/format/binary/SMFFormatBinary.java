...
public final class SMFFormatBinary implements SMFParserProviderType
{
  ...
  private static final class V1Parser extends BinaryParser
  {
  ...
  private static abstract class BinaryParser implements
  ...
  private static final class Parser extends BinaryParser
  {
    private Optional<BinaryParser> parser;
    ...
    private Optional<BinaryParser> parseMagicNumberAndVersion()
    {
      try {
    ...
    private Optional<BinaryParser> parseVersion()
      throws IOException
    {
      ...
      switch ((int) major) {
        case 1: {
          ...
          return Optional.of(
            new V1Parser(super.events, super.reader, super.state));
        }
